...
public class MenuPanel extends javax.swing.JPanel {
       public MenuPanel(ReservasiMejaTubes mainApp) {
        setLayout(null);

        JLabel label = new JLabel("Panel Menu");
        label.setBounds(350, 100, 200, 30);
        add(label);

        JButton adminButton = new JButton("Admin");
        adminButton.setBounds(300, 200, 100, 30);
        add(adminButton);

        JButton pelangganButton = new JButton("Pelanggan");
        pelangganButton.setBounds(450, 200, 100, 30);
        add(pelangganButton);

        // Aksi Tombol
        adminButton.addActionListener(e -> mainApp.showPanel("Admin")); //ini di sesuaikan nama panel nya di setiap 
        pelangganButton.addActionListener(e -> mainApp.showPanel("Pelanggan"));
    }
